...
namespace JosephM.Xrm.Sms.Plugins.Xrm
{
    ...
    public static class XrmEntity
    {
        ...
        public static IEnumerable<Entity> GetActivityParties(this Entity entity, string fieldName)
        {
            ...
            else if (fieldValue is DataCollection<Entity> dc)
            {
                return dc.ToArray();
            }
            else if(fieldValue is EntityCollection ec)
            {
                return ec.Entities.ToArray();
            }
            else if (fieldValue is Entity[] array)
            {
                return array;
            }
            throw new InvalidPluginExecutionException($"unexpected field type of {fieldValue.GetType().Name} getting parties for {fieldName}");
        }
        ...
        public static void AddActivityParty(this Entity entity, string fieldName, string type, Guid id)
        {
            ...
            SetField(entity, fieldName, new EntityCollection(parties));
        }
