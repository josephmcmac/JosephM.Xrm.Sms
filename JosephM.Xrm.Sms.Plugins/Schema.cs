...
namespace Schema
{
	public static class Entities
	{
		...
		public const string jmcg_bulksms = "jmcg_bulksms";
		public const string jmcg_bulksmserror = "jmcg_bulksmserror";
		public const string jmcg_sms = "jmcg_sms";
		public const string jmcg_smssettings = "jmcg_smssettings";
	...
	public static class Fields
	{
		...
		public static class jmcg_bulksms_
		{
			public const string createdby = "createdby";
			public const string createdon = "createdon";
			public const string createdonbehalfby = "createdonbehalfby";
			public const string importsequencenumber = "importsequencenumber";
			public const string jmcg_bulksmsid = "jmcg_bulksmsid";
			public const string jmcg_fatalerror = "jmcg_fatalerror";
			public const string jmcg_lastsendprocessid = "jmcg_lastsendprocessid";
			public const string jmcg_marketinglist = "jmcg_marketinglist";
			public const string jmcg_name = "jmcg_name";
			public const string jmcg_sendingmessages = "jmcg_sendingmessages";
			public const string jmcg_sendmessages = "jmcg_sendmessages";
			public const string jmcg_smscontent = "jmcg_smscontent";
			public const string modifiedby = "modifiedby";
			public const string modifiedon = "modifiedon";
			public const string modifiedonbehalfby = "modifiedonbehalfby";
			public const string overriddencreatedon = "overriddencreatedon";
		...
		public static class jmcg_bulksmserror_
		{
			public const string createdby = "createdby";
			public const string createdon = "createdon";
			public const string createdonbehalfby = "createdonbehalfby";
			public const string importsequencenumber = "importsequencenumber";
			public const string jmcg_bulksms = "jmcg_bulksms";
			public const string jmcg_bulksmserrorid = "jmcg_bulksmserrorid";
			public const string jmcg_contact = "jmcg_contact";
			public const string jmcg_errordetails = "jmcg_errordetails";
			public const string jmcg_name = "jmcg_name";
			public const string jmcg_sendprocessid = "jmcg_sendprocessid";
			public const string jmcg_sms = "jmcg_sms";
			public const string modifiedby = "modifiedby";
			public const string modifiedon = "modifiedon";
			public const string modifiedonbehalfby = "modifiedonbehalfby";
		...
		public static class jmcg_sms_
		{
			...
			public const string isworkflowcreated = "isworkflowcreated";
			public const string jmcg_bulksms = "jmcg_bulksms";
			public const string jmcg_sendandcomplete = "jmcg_sendandcomplete";
			public const string jmcg_setsentonregardingfield = "jmcg_setsentonregardingfield";
			public const string leftvoicemail = "leftvoicemail";
			public const string modifiedby = "modifiedby";
			public const string modifiedon = "modifiedon";
			public const string modifiedonbehalfby = "modifiedonbehalfby";
		...
		public static class jmcg_smssettings_
		{
			public const string createdby = "createdby";
			public const string createdon = "createdon";
			public const string createdonbehalfby = "createdonbehalfby";
			public const string importsequencenumber = "importsequencenumber";
			public const string jmcg_actuallysendsms = "jmcg_actuallysendsms";
			public const string jmcg_apikey = "jmcg_apikey";
			public const string jmcg_apisecret = "jmcg_apisecret";
			public const string jmcg_name = "jmcg_name";
			public const string jmcg_smsprovider = "jmcg_smsprovider";
			public const string jmcg_smssettingsid = "jmcg_smssettingsid";
			public const string jmcg_smssource = "jmcg_smssource";
			public const string modifiedby = "modifiedby";
			public const string modifiedon = "modifiedon";
			public const string modifiedonbehalfby = "modifiedonbehalfby";
			public const string overriddencreatedon = "overriddencreatedon";
	...
	public static class OptionSets
	{
		...
		public static class DuplicateDetectionRule
		{
			public static class BaseRecordType
			{
				...
				public const int BulkSMSError = 10014;
				...
				public const int Goal = 9600;
				public const int Fax = 4204;
				public const int SMSSettings = 10015;
				...
				public const int BulkSMS = 10013;
